...
public class EventComponentException extends RuntimeException {
	...
	public EventComponentException() {
		super();
		// TODO Auto-generated constructor stub
	}

	public EventComponentException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
	...
	public EventComponentException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}

	public EventComponentException(String code, String message) {
		this(message);
		this.code = code;
	}
